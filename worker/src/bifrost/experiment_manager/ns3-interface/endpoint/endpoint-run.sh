...
if [ $1 = "client" ];then
  ...
  udp_in_listen="10.0.0.100:8889"
  # 配置输出的流向
  udp_out_server="10.0.0.2:9999"
  udp_out_listen="10.0.0.100:8887"
elif [ $1 = "server" ]; then
  # 配置输入的流向
  udp_in_server="10.0.0.100:8887"
  udp_in_listen="10.100.0.100:8887"
  # 配置输出的流向
  udp_out_server="10.100.0.2:7777"
  udp_out_listen="10.100.0.100:8889"
else
